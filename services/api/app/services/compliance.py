...
from app.models.enums import LicenceStatus, ObligationStatus, RiskLevel
...
LICENCE_WEIGHT = 40.0
OBLIGATION_WEIGHT = 45.0
TIMELINESS_WEIGHT = 15.0
...
def score_leases(
    ...
    return {
        lease_id: _build_assessment(
            lease_id, licences.get(lease_id, {}), obligations.get(lease_id, {}), warning_days
        )
